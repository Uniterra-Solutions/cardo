...
| ----------------------------------------- | ------- | -------------------------------------------------------------- |
| @uniterra-solutions/uniterra-desktop      | 0.11.5  | Electron shell over the bundled dsh CLI; built-in provisioning |
| @uniterra-solutions/uniterra              | 0.11.5  | Public npm installer CLI (bin `uniterra`)                      |
