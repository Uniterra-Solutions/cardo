...
| ------------------------- | ------- | -------------------------------------------------------------- |
| @cardo/cardo-desktop      | 0.8.4   | Electron shell over the bundled dsh CLI; built-in provisioning |
| @uniterra-solutions/cardo | 0.8.4   | Public npm installer CLI (bin `cardo`)                         |
| @cardo/cardo-provider     | 0.1.3   | In-house dual-protocol LLM provider plugin                     |
