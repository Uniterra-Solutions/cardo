...
| ----------------------------------------- | ------- | -------------------------------------------------------------- |
| @uniterra-solutions/uniterra-desktop      | 0.8.4   | Electron shell over the bundled dsh CLI; built-in provisioning |
| @uniterra-solutions/uniterra              | 0.8.4   | Public npm installer CLI (bin `uniterra`)                      |
