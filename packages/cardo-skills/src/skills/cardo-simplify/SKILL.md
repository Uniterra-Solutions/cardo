...
description: >
  ...
  Do NOT use for adversarial correctness review (cardo-review), planning
  (cardo-plan), or implementing (cardo-implement).
---

# Cardo Simplify — scope-bound simplification loop

Pipeline position: after `cardo-implement`, or standalone. Only two things
