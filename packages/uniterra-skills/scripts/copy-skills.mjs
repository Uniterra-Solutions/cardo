 ...
 * consumer that loads `@uniterra-solutions/skills` from `dist` (the desktop app via the
...
// Remove stale entries from a previous build (a skill deleted from src must
// not linger in dist and keep shipping as a bundled skill).
